function setup() { "use strict";
    ...
    function draw() {
      ...
      function DrawSharingan3(color, width) {
        context.beginPath(); //iris
...
//         context.strokeStyle = "black";
      ...
      function DrawDrops() {
        ...
        context.arc(-78, 50 + hmod, 5, 0, 2 * Math.PI);
        context.arc(62, 57 + hmod, 7.5, 0, 2 * Math.PI);
        context.fill();
      }
